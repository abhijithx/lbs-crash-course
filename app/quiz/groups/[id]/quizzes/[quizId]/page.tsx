  ...
  useEffect(() => {
    async function fetchQuizAndQuestions() {
      ...
      try {
        ...
        const getUTCNow = async (): Promise<Date> => {
  const res = await fetch('https://worldtimeapi.org/api/timezone/Etc/UTC');
  const data = await res.json();
  return new Date(data.datetime); // Convert ISO string to Date object
};
                  ...
                  <TooltipTrigger asChild>
                    <Button
                      ...
                      className={cn(
                        ...
                        status === "incorrect" &&
                          "bg-red-100 border-red-500 text-red-700 hover:bg-red-200 hover:text-red-800",
                        status === "answered" &&
                          "bg-blue-100 border-blue-500 text-blue-700 hover:bg-blue-200 hover:text-blue-800",
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Card className="max-w-2xl mx-auto">
          ...
          <CardFooter>
               ...
               <Button variant="ghost" className="mb-4"  onClick={() => window.history.back()}><ArrowLeft className="mr-2 h-4 w-4" />Go Back</Button>
          </CardFooter>
        </Card>
